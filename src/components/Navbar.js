...
function Navbar() {
  return (
      <aside
        id="default-sidebar"
        className="fixed z-40 w-20 h-screen transition-transform p-2 -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#121212] ">
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M1.7696 9.78238C4.14661 4.07465 9.71602 0.350225 15.8989 0.333711C22.5626 0.29862 28.4877 4.56692 30.5649 10.8987C32.6421 17.2304 30.3968 24.1791 25.0074 28.0982C19.6179 32.0173 12.3154 32.0114 6.93223 28.0837L2.13223 32.8837C1.6442 33.3711 0.853596 33.3711 0.365567 32.8837C-0.121856 32.3957 -0.121856 31.6051 0.365567 31.117L5.01557 26.467C0.672072 22.0668 -0.607407 15.4901 1.7696 9.78238ZM3.99818 20.6153C5.99397 25.4247 10.6918 28.5571 15.8989 28.5504V28.4837C22.966 28.4747 28.7031 22.7674 28.7489 15.7004C28.7556 10.4933 25.6233 5.79545 20.8138 3.79966C16.0043 1.80387 10.4661 2.90363 6.78414 6.58561C3.10215 10.2676 2.00239 15.8058 3.99818 20.6153Z"
                    fill="white"
                  />
                </svg>
              </Link>
